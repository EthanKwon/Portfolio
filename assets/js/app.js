...
class Intro {
  ...
  layout(scrollValue) {
    ...
    this.DOM.image.style.transform = `translate3d(0, ${scrollValue / 10}px, 0)`;
...
class Project {
  constructor() {
    ...
    this.DOM.imgFirstLine = this.DOM.project.querySelectorAll(".js-first-line");
    ...
    this.DOM.secondShow = this.DOM.project.querySelectorAll(".js-second-show");
